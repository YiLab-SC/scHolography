...
as.numeric(unlist(strsplit(mouse1sample1.boundary$boundaryX[1],",")))
as.numeric(unlist(strsplit(mouse1sample1.boundary$boundaryY[1],",")))

mouse1sample1.boundary.cent <- matrix(nrow=nrow(mouse1sample1.boundary), ncol = 2)
for (i in 1:nrow(mouse1sample1.boundary)) {
  if(length(unlist(strsplit(mouse1sample1.boundary$boundaryX[i],",")))<3){
    mouse1sample1.boundary.cent[i, ]<- c(NA,NA)
  }else{
    mouse1sample1.boundary.cent[i, ]<- unlist(centroids(vect(cbind(
      as.numeric(unlist(strsplit(mouse1sample1.boundary$boundaryX[i],","))),
      as.numeric(unlist(strsplit(mouse1sample1.boundary$boundaryY[i],",")))),
