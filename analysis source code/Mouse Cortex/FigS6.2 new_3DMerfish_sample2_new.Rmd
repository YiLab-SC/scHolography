...
merfish.seurat.mouse1_sample2 <- readRDS("/projects/b1042/YiLab/Cady/Code_3rdDraft/Merfish_3D//merfish.seurat.mouse1_sample2.rds")
```


```{r}
merfish.seurat.mouse1_sample2.slice62.sub <- readRDS("/projects/b1042/YiLab/Cady/Code_3rdDraft/Merfish_3D/paste_sample2/mouse1_slice62_1500sub.rds")
merfish.seurat.mouse1_sample2.slice71.sub <- readRDS("/projects/b1042/YiLab/Cady/Code_3rdDraft/Merfish_3D/paste_sample2/mouse1_slice71_1500sub.rds")
merfish.seurat.mouse1_sample2.slice81.sub <- readRDS("/projects/b1042/YiLab/Cady/Code_3rdDraft/Merfish_3D/paste_sample2/mouse1_slice81_1500sub.rds")
merfish.seurat.mouse1_sample2.slice91.sub <- readRDS("/projects/b1042/YiLab/Cady/Code_3rdDraft/Merfish_3D/paste_sample2/mouse1_slice91_1500sub.rds")
merfish.seurat.mouse1_sample2.slice102.sub <- readRDS("/projects/b1042/YiLab/Cady/Code_3rdDraft/Merfish_3D/paste_sample2/mouse1_slice102_1500sub.rds")
...
paste.pred <- read.csv("/projects/b1042/YiLab/Cady/Code_3rdDraft/Merfish_3D/paste_sample2/filename.csv")
...
saveRDS(merfish.seurat.mouse1_sample2.sub.comb,"/projects/b1042/YiLab/Cady/Code_3rdDraft/Merfish_3D/paste_sample2/merfish.seurat.mouse1_sample2.sub.comb.rds")
...
tiff("/projects/b1042/YiLab/Cady/Code_3rdDraft/Merfish_3D///sample2_Merfish.dist.3D.layer.tiff", units="in", width=8, height=6, res=600)
...
tiff("/projects/b1042/YiLab/Cady/Code_3rdDraft/Merfish_3D///sample2_Merfish.dist.3D.layer.zlayer.tiff", units="in", width=8, height=6, res=600)
...
```{r}
### scHolography Inference (slice62 Reference on slice62 Query)
library(scHolography)
...
sp.integrated.merfish.slice62toslice62 <- dataAlign(low.res.sp =  merfish.seurat.mouse1_sample2.slice62.sub_dup,high.res.sp =  merfish.seurat.mouse1_sample2.slice62.sub,scProcessed = T,stProcessed = T,future.size = 7000)
scHolography.obj.slice62toslice62<- trainHolography(sp.integrated.merfish.slice62toslice62)
saveRDS(scHolography.obj.slice62toslice62,"/projects/b1042/YiLab/Cady/Code_3rdDraft/Merfish_3D/paste_sample2//merfish.slice62toslice62.rds")
scHolographyPlot(scHolography.obj.slice62toslice62,color.by = "subclass")


def.col <- rep("black",length(unique(scHolography.obj.slice62toslice62$scHolography.sc$subclass)))
def.col[which(stringr::str_sort(unique(scHolography.obj.slice62toslice62$scHolography.sc$subclass),numeric = T)%in%stringr::str_sort(unique(scHolography.obj.slice62toslice62$scHolography.sc$subclass[which(scHolography.obj.slice62toslice62$scHolography.sc$class_label%in%"Glutamatergic")]),numeric = T))] <-(RColorBrewer::brewer.pal(12,"Paired"))[1:9] 




fig.2dq <- scHolographyPlot(scHolography.obj.slice62toslice62,color.by = "subclass",cells =which(scHolography.obj.slice62toslice62$scHolography.sc$class_label%in%"Glutamatergic") ,color = def.col)%>% plotly::layout(scene = list(camera = list(eye = list(x = 2.25, z = 0, y = 0))))
...
```{r}
merfish.seurat.mouse1_sample2.slice62.sub.glu.sub <- merfish.seurat.mouse1_sample2.slice62.sub[,which(merfish.seurat.mouse1_sample2.slice62.sub$class_label%in%"Glutamatergic")]

slice62 <-plot_ly(merfish.seurat.mouse1_sample2.slice62.sub.glu.sub@meta.data,x=~CentroidX,y=~-CentroidY,color=~subclass,colors = "Paired", marker = list(size = 3))%>% add_markers()
slice62
#plotly::orca(slice62, "slice62.svg",width = 4.5,height = 6)

#tiff("/projects/b1042/YiLab/Cady/Code_3rdDraft/Merfish_3D///slice62.tiff", units="in", width=8, height=7, res=600)
ggplot(merfish.seurat.mouse1_sample2.slice62.sub.glu.sub@meta.data)+
...
saveRDS(scHolography.obj.slice3Dtoslice62,"/projects/b1042/YiLab/Cady/Code_3rdDraft/Merfish_3D/paste_sample2//merfish.slice3Dtoslice62.rds")
...
tiff("/projects/b1042/YiLab/Cady/Code_3rdDraft/Merfish_3D///sample2_s62_Cortex.dist.3D.layer.tiff", units="in", width=5, height=6, res=600)
...
```{r}
scHolography::clusterDistanceBoxplot(scHolography.obj.slice3Dtoslice62,annotationToUse = "subclass",query.cluster.list = c(
...
tiff("/projects/b1042/YiLab/Cady/Code_3rdDraft/Merfish_3D//sample2_s62_Cortex.dist.3D.tiff", units="in", width=5, height=6, res=600)
scHolography::clusterDistanceBoxplot(scHolography.obj.slice3Dtoslice62,annotationToUse = "subclass",query.cluster.list = c(
  "L2/3 IT","L4/5 IT","L5 IT","L6 IT"),reference.cluster = c("L6 IT","L6 IT Car3","L6 CT","L6b"))+ theme(legend.position = "none")+scale_fill_manual(values = color[c(1,2,4,7,8,3,5,6,9)])+theme_classic()+ ylim(c(.9,7.5))+
...
sp.integrated.merfish.slice102toslice102 <- dataAlign(low.res.sp =  merfish.seurat.mouse1_sample2.slice102.sub_dup,high.res.sp =  merfish.seurat.mouse1_sample2.slice102.sub,scProcessed = T,stProcessed = T,future.size = 7000)
scHolography.obj.slice102toslice102<- trainHolography(sp.integrated.merfish.slice102toslice102)
saveRDS(scHolography.obj.slice102toslice102,"/projects/b1042/YiLab/Cady/Code_3rdDraft/Merfish_3D/paste_sample2//merfish.slice102toslice102.rds")
scHolographyPlot(scHolography.obj.slice102toslice102,color.by = "subclass")


def.col <- rep("black",length(unique(scHolography.obj.slice102toslice102$scHolography.sc$subclass)))
def.col[which(stringr::str_sort(unique(scHolography.obj.slice102toslice102$scHolography.sc$subclass),numeric = T)%in%stringr::str_sort(unique(scHolography.obj.slice102toslice102$scHolography.sc$subclass[which(scHolography.obj.slice102toslice102$scHolography.sc$class_label%in%"Glutamatergic")]),numeric = T))] <-(RColorBrewer::brewer.pal(12,"Paired"))[1:9] 




fig.2dq <- scHolographyPlot(scHolography.obj.slice102toslice102,color.by = "subclass",cells =which(scHolography.obj.slice102toslice102$scHolography.sc$class_label%in%"Glutamatergic") ,color = def.col)%>% plotly::layout(scene = list(camera = list(eye = list(x = 2.25, z = 0, y = 0))))
...
```{r}
merfish.seurat.mouse1_sample2.slice102.sub.glu.sub <- merfish.seurat.mouse1_sample2.slice102.sub[,which(merfish.seurat.mouse1_sample2.slice102.sub$class_label%in%"Glutamatergic")]

slice102 <-plot_ly(merfish.seurat.mouse1_sample2.slice102.sub.glu.sub@meta.data,x=~CentroidX,y=~-CentroidY,color=~subclass,colors = "Paired", marker = list(size = 3))%>% add_markers()
slice102
#plotly::orca(slice102, "slice102.svg",width = 4.5,height = 6)

#tiff("/projects/b1042/YiLab/Cady/Code_3rdDraft/Merfish_3D///slice102.tiff", units="in", width=8, height=7, res=600)
ggplot(merfish.seurat.mouse1_sample2.slice102.sub.glu.sub@meta.data)+
  geom_point(aes(x=CentroidX,y = -CentroidY,color=subclass))+theme_void()+scale_color_brewer(palette = "Paired")+theme(axis.title = element_blank(),axis.text = element_blank(),axis.ticks = element_blank())+Seurat::NoLegend()
#dev.off()
```
...
saveRDS(scHolography.obj.slice3Dtoslice102,"/projects/b1042/YiLab/Cady/Code_3rdDraft/Merfish_3D/paste_sample2//merfish.slice3Dtoslice102.rds")
...
library(ggsignif)
my_comparisons <- list( c("620","710"), c("710","810"), c("810","910"), c("910","1020"),c("620","810"),c("810","1020"))
tiff("/projects/b1042/YiLab/Cady/Code_3rdDraft/Merfish_3D//sample2_s102_Cortex.dist.3D.layer.tiff", units="in", width=5, height=6, res=600)
...
tiff("/projects/b1042/YiLab/Cady/Code_3rdDraft/Merfish_3D//sample2_s102_Cortex.dist.3D.tiff", units="in", width=5, height=6, res=600)
scHolography::clusterDistanceBoxplot(scHolography.obj.slice3Dtoslice102,annotationToUse = "subclass",query.cluster.list = c(
