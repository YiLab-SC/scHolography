...
library(terra)
library(ggplot2)
counts_h5ad <- readH5AD("~/OneDrive - Northwestern University/Northwestern/Yi Lab/Manuscript/Code_3rdDraft/Merfish_3D//data/counts.h5ad")
counts.mat <- counts_h5ad@assays@data$X
merfish.meta <- read.csv("~/OneDrive - Northwestern University/Northwestern/Yi Lab/Manuscript/Code_3rdDraft/Merfish_3D//data/cell_labels.csv")
...
mouse1sample1.boundary <- read.csv("~/OneDrive - Northwestern University/Northwestern/Yi Lab/Manuscript/Code_3rdDraft/Merfish_3D//data/segmented_cells_mouse1sample1.csv")
...
saveRDS(merfish.seurat.mouse1_sample1,"~/OneDrive - Northwestern University/Northwestern/Yi Lab/Manuscript/Code_3rdDraft/Merfish_3D//merfish.seurat.mouse1_sample1.rds")
```

```{r}
# Process data for sample2
mouse1sample2.boundary <- read.csv("~/OneDrive - Northwestern University/Northwestern/Yi Lab/Manuscript/Code_3rdDraft/Merfish_3D//data/segmented_cells_mouse1sample2.csv")
...
saveRDS(merfish.seurat.mouse1_sample2,"~/OneDrive - Northwestern University/Northwestern/Yi Lab/Manuscript/Code_3rdDraft/Merfish_3D//merfish.seurat.mouse1_sample2.rds")
```
...
save_seurat_data <- function(seurat_object.og, prefix,wd) {
  ...
  set.seed(60611)
  seurat_object <- subset(seurat_object.og,cells=sort(sample(which(is.na(rowSums(seurat_object.og@meta.data[, c("CentroidX", "CentroidY")]))==F),1500)))
...
save_seurat_sample_to_paste(seurat_list = merfish.seurat.mouse1_sample2.slice.list, my_dir="~/OneDrive - Northwestern University/Northwestern/Yi Lab/Manuscript/Code_3rdDraft/Merfish_3D/",this_name="paste_sample2/")

save_seurat_sample_to_paste(seurat_list = merfish.seurat.mouse1_sample1.slice.list, my_dir="~/OneDrive - Northwestern University/Northwestern/Yi Lab/Manuscript/Code_3rdDraft/Merfish_3D/",this_name="paste_sample1/")
