...
```{r}
clusterDistanceBoxplot(hippo.brain.obj.visium,annotationToUse = "celltype",query.cluster.list = c("CA1 Principal cells","CA2 Principal cells","CA3 Principal cells"),reference.cluster=c(  "CA1 Principal cells"))
```
