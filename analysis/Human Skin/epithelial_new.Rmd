...
VlnPlot(scHolography.obj$scHolography.sc,c("ITGB4","LAMB3","DST","COL17A1"),idents = c("Transition_KC","Differentiated_KC","vvvvvvvvvvvvvvvvvvvvvvvccccccccccccvc  "),assay = "SCT",ncol = 2,cols = my.col)
