...
scHolographyPlot<-function(scHolography.obj, dim=3, cells=NULL,feature=NULL,cutoff=NULL, color.by="orig.cluster", dot.size = 3 , palette="Paired", highlight=NULL,assayToUse="SCT"){
